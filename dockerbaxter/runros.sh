...
sudo docker run -it --net host -e QT_X11_NO_MITSHM=1 $MYNVIDIA -v /usr/bin/X11/xeyes:/usr/bin/X11/xeyes -v /tmp/.X11-unix:/tmp/.X11-unix -e DISPLAY=$DISPLAY --device /dev/snd $TARGET
#TODO fix 
#TODO add 
